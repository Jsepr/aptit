...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    error: 'Could not extract recipe. Please check the URL or try a different one.',
    tryAgain: 'Try Again',
  ...
  sv: {
    ...
    error: 'Kunde inte hämta receptet. Kontrollera länken eller försök med en annan.',
